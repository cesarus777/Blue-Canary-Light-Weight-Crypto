...
static const uint32_t inv_MC0[256] = {
...
static const uint32_t inv_MC1[256] = {
    0x0,        0xd090e0b,  0x1a121c16, 0x171b121d, 0x3424382c, 0x392d3627,
    ...
    0x459d1ff1, 0x489411fa, 0x3e34b93,  0xeea4598,  0x19f15785, 0x14f8598e,
    ...
    0x53eddae,  0x837d3a5,  0x1f2cc1b8, 0x1225cfb3, 0x311ae582, 0x3c13eb89,
    ...
    0x8a213ef9, 0x872830f2, 0x903322ef, 0x9d3a2ce4, 0x6dd963d,  0xbd49836,
    ...
    0xa7ca147,  0x775af4c,  0x106ebd51, 0x1d67b35a, 0x3e58996b, 0x33519760,
    ...
    0x99fead4,  0x496e4df,  0x138df6c2, 0x1e84f8c9, 0x3dbbd2f8, 0x30b2dcf3,
    ...
    0xf427ce9,  0x24b72e2,  0x155060ff, 0x18596ef4, 0x3b6644c5, 0x366f4ace,
    0x217458d3, 0x2c7d56d8, 0xca1377a,  0x1a83971,  0x16b32b6c, 0x1bba2567,
...
static const uint32_t inv_MC2[256] = {
    0x0,        0x90e0b0d,  0x121c161a, 0x1b121d17, 0x24382c34, 0x2d362739,
    ...
    0x1fe3578f, 0x16ed5c82, 0xdff4195,  0x4f14a98,  0x73ab23d3, 0x7aa528de,
    ...
    0x8f9942b,  0x1f79f26,  0xe64d46bd, 0xef434db0, 0xf45150a7, 0xfd5f5baa,
    ...
    0x7b52b7f8, 0x725cbcf5, 0x506d5be,  0xc08deb3,  0x171ac3a4, 0x1e14c8a9,
    ...
    0x10e93356, 0x19e7385b, 0x2f5254c,  0xbfb2e41,  0xd79a8c61, 0xde94876c,
    ...
    0x63421085, 0x6a4c1b88, 0x715e069f, 0x78500d92, 0xf0a64d9,  0x6046fd4,
    ...
    0xf6a475eb, 0xffaa7ee6, 0xe4b863f1, 0xedb668fc, 0xa0cb167,  0x302ba6a,
    ...
    0x7f3f0f2,  0xefdfbff,  0x79a792b4, 0x70a999b9, 0x6bbb84ae, 0x62b58fa3,
    0x5d9fbe80, 0x5491b58d, 0x4f83a89a, 0x468da397};

static const uint32_t inv_MC3[256] = {
    0x0,        0xe0b0d09,  0x1c161a12, 0x121d171b, 0x382c3424, 0x3627392d,
    ...
    0x3bcb6bab, 0x35c066a2, 0x27dd71b9, 0x29d67cb0, 0x3e75f8f,  0xdec5286,
    ...
    0x2108cfbc, 0x2f03c2b5, 0x532e18a,  0xb39ec83,  0x1924fb98, 0x172ff691,
    0x768dd64d, 0x7886db44, 0x6a9bcc5f, 0x6490c156, 0x4ea1e269, 0x40aaef60,
    0x52b7f87b, 0x5cbcf572, 0x6d5be05,  0x8deb30c,  0x1ac3a417, 0x14c8a91e,
    ...
    0x2db9a8b6, 0x23b2a5bf, 0x9838680,  0x7888b89,  0x15959c92, 0x1b9e919b,
    ...
    0x42108563, 0x4c1b886a, 0x5e069f71, 0x500d9278, 0xa64d90f,  0x46fd406,
    ...
    0xa475ebf6, 0xaa7ee6ff, 0xb863f1e4, 0xb668fced, 0xcb1670a,  0x2ba6a03,
    ...
    0xf563885,  0x15d358c,  0x13402297, 0x1d4b2f9e, 0x472264e9, 0x492969e0,
...
static const uint8_t rc_tab[10] = {0x01, 0x02, 0x04, 0x08, 0x10,
...
static void run_decryption_key_schedule(uint8_t *key, uint8_t *round_keys) {
  uint8_t i;
  uint8_t rc = 0;
...
static inline void decrypt_round(uint8_t *state, uint8_t *round_keys, int n) {
  ...
  for (int i = 0; i < 16; ++i) {
    if (Nr != n)
      tmp[i] = state[i] ^ round_keys[4 * Nb * n + i];
    else
      state[i] ^= round_keys[4 * Nb * n + i];
  }
...
void decrypt(uint8_t *block) {
  uint8_t keys[16] = {0xf5, 0x30, 0x35, 0x79, 0x68, 0x57, 0x84, 0x80,
                      0xb3, 0x98, 0xa3, 0xc2, 0x51, 0xcd, 0x10, 0x93};
  uint8_t round_keys[16 * 11];
  run_decryption_key_schedule(keys, round_keys);
